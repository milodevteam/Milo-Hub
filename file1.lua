...
v3.Window = function(v110, v111)
	...
	v132.Color = Color3.fromRGB(242, 41, 108);
	...
	v146.Image = "http://www.roblox.com/asset/?id="   .. tostring(118354174395007) ;
	...
	v173.Text = "Haha Gamer Hub";
	v173.TextSize = 17;
	v173.TextColor3 = Color3.fromRGB(242, 41, 108);
...
v6.Image = "rbxassetid://135920566704171";
v6.Draggable = true;
...
v32:Button("Copy Discord Link", function()
	setclipboard("https://discord.com/invite/e6yjqPzWqT");
end);
v32:Seperator("Time");
...
v37:Seperator("Prehistoric Island");
	...
	while task.wait() do
		pcall(function()
			if game.Workspace._WorldOrigin.Locations:FindFirstChild("Prehistoric Island") then
				...
				v74:Set("Prehistoric Island : Don't Spawn!");
			end
		end);
	end
end);
...
v37:Seperator("Status Leviathan");
local v103 = v37:Label("Status Leviathan Chip: ");
task.spawn(function()
    while task.wait() do
        pcall(function()
            if game:GetService("ReplicatedStorage").Remotes.CommF:InvokeServer("InfoLeviathan", "1") then
                v103:Set("Status Leviathan Chip: Leviathan Is Out There"); 
            else
                v103:Set("Status Leviathan Chip: Leviathan Don't Spawn")
            end
        end);
    end
end);
local v104 = v37:Label("Status Can Buy Chip Or No: ");
task.spawn(function()
    while task.wait() do
        pcall(function()
            if game:GetService("ReplicatedStorage").Remotes.CommF:InvokeServer("InfoLeviathan", "1") then
                v104:Set("Status Buy Chip: I am readly"); 
            else
                v104:Set("Status Buy Chip: I Don't Know")
            end
        end);
    end
end);
v37:Button("Buy Chip Leviathan-Spy [Use 1.5K Fragments]", function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("InfoLeviathan", "2");
end);
v37:Toggle("Find Leviathan", false, function(v611)
	_G.AutoFindFrozen = v611;
end);
local v105 = {};
local v106 = false;
local v107 = false;
v77.RenderStepped:Connect(function()
	...
	local v612 = v76.LocalPlayer;
	local v613 = v612.Character;
	if (not v613 or not v613:FindFirstChild("Humanoid")) then
		return;
	end
	local function v614()
		if v106 then
		...
		v106 = true;
		for v813, v814 in pairs(v105) do
			if (v814 and v814.Parent and (v814.Name == "VehicleSeat") and not v814.Occupant) then
				Tween2(v814.CFrame);
				break;
			end
		end
	...
	local v615 = v613.Humanoid;
	local v616 = false;
	local v617 = nil;
	for v806, v807 in pairs(v79.Boats:GetChildren()) do
		local v808 = v807:FindFirstChild("VehicleSeat");
		if (v808 and (v808.Occupant == v615)) then
			v616 = true;
			v617 = v808;
			v105[v807.Name] = v905;
		elseif (v808 and (v808.Occupant == nil)) then
	...
	v617.MaxSpeed = v80;
	v617.CFrame = CFrame.new(Vector3.new(v617.Position.X, v617.Position.Y, v617.Position.Z)) * v617.CFrame.Rotation ;
	v78:SendKeyEvent(true, "W", false, game);
	for v1456, v1457 in pairs(v79.Boats:GetDescendants()) do
		if v1457:IsA("BasePart") then
			v1457.CanCollide = false;
		end
	end
	for v1458, v1459 in pairs(v613:GetDescendants()) do
		if v1459:IsA("BasePart") then
			v1459.CanCollide = false;
		end
	end
	local v620 = {
		"ShipwreckIsland",
	...
	for v1460, v1461 in ipairs(v620) do
		local v1462 = v79.Map:FindFirstChild(v1461);
		if (v1462 and v1462:IsA("Model")) then
			v1462:Destroy();
		end
	end
	local v621 = v79.Map:FindFirstChild("FrozenDimension");
	if v621 then
		v78:SendKeyEvent(false, "W", false, game);
		...
		if not v107 then
            ...
            game:GetService("StarterGui"):SetCore("SendNotification", {
	            ...
	            Text = "Đã tìm thấy đảo Leviathan",
	            Icon = "rbxthumb://type=Asset&id=135920566704171&w=150&h=150",
	            Duration = 10
            });
			v107 = true;
		end
...
v37:Button("Remove Fog", function()
	game:GetService("Lighting").LightingLayers:Destroy();
	game:GetService("Lighting").Sky:Destroy();
end);
v37:Toggle("NoClip Rock", _G.NoClipRock, function(v1434)
	_G.NoClipRock = v1434;
end);
task.spawn(function()
    while task.wait() do
        pcall(function()
			for v1456, v1457 in pairs(game:GetService("Workspace").Boats:GetChildren()) do
				for v1458, v1459 in pairs(game:GetService("Workspace").Boats[v1457.Name]:GetDescendants()) do
					if v1459:IsA("BasePart") then
						if (_G.NoClipRock or _G.SailBoat) then
							v1459.CanCollide = false;
						else
							v1459.CanCollide = true;
						end
					end
				end
			end
...
v37:Toggle("Press W Auto", _G.r71PressW, function(v1435)
	_G.r71PressW = v1435;
end);
task.spawn(function()
    while task.wait() do
...
v44:Seperator(" Anti Band ");
v44:Toggle("Anti Band", true, function(v610)
    _G.AntiBand = v610;
end);
local v108 = {
    17884881,
    ...
    while wait() do
        if _G.AntiBand then
            for v809, v810 in pairs(game:GetService("Players"):GetPlayers()) do
                if table.find(v108, v810.UserId) then
                    Hop();
                end
            end
        end
